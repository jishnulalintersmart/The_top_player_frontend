            ...
            <div className={styles.lftSd}>
              <div className={styles.cntWrap}>
                ...
                <div className={styles.list_bx}>
                  <ul>
                    <li>Training duration is 4 weeks</li>
                    <li>5 days training and 2 days rest per week</li>
                    <li>Each day contains 8 exercises</li>
                    <li>
                      Power, flexibility, agility, stamina and body weight
                      exercise
                    </li>
                    <li>The subscription is valid for 3 months</li>
                  </ul>
                </div>
